...
func (this *MssqlDbInfo) QueryIdList(sql string, para ...string) (ids []string, err error) {
...
func (this *MssqlDbInfo) QueryIdIntList(sql string, para ...string) (ids []int, err error) {
	err = this.SqlDataDb.Select(&ids, sql, para)
	if err != nil {
		err := this.SqlDataDb.Select(&ids, sql, para)
		if err != nil {
